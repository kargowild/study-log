...
Red Green Refactor의 반복적인 사이클을 따름으로써 스스로 작성한 코드에 대해 가장 빠른 피드백을 받을 수 있는 방법입니다.
...
또한 테스트를 위한 API를 제공받아야 하고, 이를 매번 직접 요청한다면 테스트 속도에도 영향을 미칠 수 있게 됩니다.
...
그 때까지도 스레드 1의 트랜잭션이 커밋되지 않았다면, 대기임에도 불구하고 예약이 존재하지 않는 것으로 판단될 수 있습니다.
